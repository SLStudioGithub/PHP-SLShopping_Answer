            ...
            <div class="box box-info">
                ...
                <form method="post" action="{{ route('admin.items.create') }}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="main_image" class="asterisk">メイン画像</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea 
                                ...
                                class="form-control" 
                                rows="5"
                                required>{{ old('shortDescription') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" id="full_description" name="fullDescription" class="form-control" rows="10">{{ old('fullDescription') }}</textarea>
