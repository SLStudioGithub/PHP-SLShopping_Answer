            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $adminUser->created_at->toDateTimeString() }}" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label for="updated-at">更新日時</label>
                        <input type="text" value="{{ $adminUser->updated_at->toDateTimeString() }}" class="form-control" readonly>
                    </div>
                </div>
            </div>
        </div>
